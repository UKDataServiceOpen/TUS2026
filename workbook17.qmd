...
datadir1<-"~/Data/mtus/TUS23_data/"
ep<-read_dta(paste0(datadir1,"mtus_teach_ep.dta"))%>%select(-msamp,-swave,-ict,-core25,-diary,-inout) %>%filter(child!=1)
